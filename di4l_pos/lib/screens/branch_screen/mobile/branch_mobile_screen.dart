...
class BranchMobileScreen extends StatefulWidget {
  /// MARK: - Initials;
  static BlocProvider<BranchCubit> provider(
      {TextEditingController? txtSearch}) {
    return BlocProvider(
      create: (context) => BranchCubit(),
      child: BranchMobileScreen(txtSearch),
    );
  }

  const BranchMobileScreen(this._txtSearch, {Key? key}) : super(key: key);
  final TextEditingController? _txtSearch;

  @override
  State<BranchMobileScreen> createState() => _BranchScreenState();
}

class _BranchScreenState extends State<BranchMobileScreen>
