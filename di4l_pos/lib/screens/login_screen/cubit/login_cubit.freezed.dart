...
abstract class $LoginStateDataCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? error, bool showPass});
}
...
class _$_LoginStateData
  ...
  const _$_LoginStateData({this.error, this.showPass = true});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'LoginStateData(error: $error, showPass: $showPass)';
  }
...
abstract class _LoginStateData implements LoginStateData {
  const factory _LoginStateData({final String? error, final bool showPass}) =
      _$_LoginStateData;
