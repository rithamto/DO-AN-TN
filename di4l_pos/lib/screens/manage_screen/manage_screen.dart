  ...
  static MultiBlocProvider provider() {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider<SellReportCubit>(
            create: (BuildContext context) => SellReportCubit()),
      ],
...
class _ManageScreenState extends State<ManageScreen>
  ...
  FutureOr<void> afterFirstLayout(BuildContext context) {
    ...
    context
        ...
        .getSellReportByFilter(startDate: today, endDate: today);
  }
                ...
                children: [
                  ...
                  TextButton(
                      ...
                      child: Text(
                        "${"all".tr} >",
                        style:
                            const TextStyle(color: GlobalColors.flButtonColor),
                      ))
                ],
              ),
            ),
  ...
  BlocBuilder<ManageCubit, ManageState> buildListinfoToday() {
    return BlocBuilder<ManageCubit, ManageState>(
      builder: (context, state) {
        ...
        builder: (context, state) {
          final countOrder = state.data?.response?.total ?? 0;
