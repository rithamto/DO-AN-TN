...
class _$_PrinterStateData implements _PrinterStateData {
  ...
  @override
  String toString() {
    return 'PrinterStateData(status: $status, printers: $printers, printersOriginal: $printersOriginal, isSearching: $isSearching)';
  }
...
abstract class _PrinterStateData implements PrinterStateData {
  const factory _PrinterStateData(
      ...
      final bool isSearching}) = _$_PrinterStateData;
