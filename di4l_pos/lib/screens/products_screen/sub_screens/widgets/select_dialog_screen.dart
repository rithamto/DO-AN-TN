            ...
            child: SizedBox(
              ...
              child: BlocBuilder<CategoryCubit, CategoryState>(
                ...
                if (state.data!.status == StatusType.loading)
                  return AppLoadingWidget(widget: null, text: 'Loading...');
                else
              ...
              child: Container(
                ...
                child: InkWell(
                  onTap: (() => navigator!.pushNamed(
                        RouteGenerator.addVariantionScreen,
                        arguments: <String, AddType>{
                          'ADD_VARIANTION_TYPE': AddType.NEW,
                        },
                      )),
                  child: Icon(
                    Icons.add,
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        state.data!.units
                                                ...
                                                .toString() +
                                            " " +
                                            "( ${state.data!.units.elementAt(index).shortName.toString()} )",
                                        style:
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Text(
                                        state.data!.branches
                                                ...
                                                .toString() +
                                            " " +
                                            "( ${state.data!.branches.elementAt(index).name.toString()} )",
                                        style:
                                            GlobalStyles.titleRegular(context),
                                      ),
                                    ),
                                    Padding(
                                      ...
                                      child: IconButton(
                                        ...
                                        onPressed: () {
                                          navigator!.pushNamed(
                                            RouteGenerator.addBranchScreen,
                                            arguments: <String, dynamic>{
                                              'ADD_BRANCH_TYPE': AddType.UPDATE,
                                              'BRANCH_MODEL': state
                                                  .data!.branches
                                                  .elementAt(index)
                                            },
