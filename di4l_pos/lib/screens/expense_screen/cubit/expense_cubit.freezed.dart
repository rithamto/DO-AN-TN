...
class _$_ExpenseStateData implements _ExpenseStateData {
  ...
  @override
  String toString() {
    return 'ExpenseStateData(expenses: $expenses, categories: $categories, categoriesOriginal: $categoriesOriginal, status: $status, totalExpense: $totalExpense, totalRevenue: $totalRevenue)';
  }
