...
class _$_VariantStateData implements _VariantStateData {
  ...
  @override
  String toString() {
    return 'VariantStateData(status: $status, variants: $variants, variantSelected: $variantSelected, variant: $variant, showValue: $showValue, variantOriginal: $variantOriginal)';
  }
