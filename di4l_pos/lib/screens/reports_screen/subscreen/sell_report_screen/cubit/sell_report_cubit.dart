...
class SellReportCubit extends Cubit<SellReportState> {
  ...
  Future<void> getProfitDay(String? startDate, String? endDate) async{
    // GetProfitDayRq? request;
    // request?.startDate = startDate;
    // request?.endDate = endDate;
    // request?.locationId = null;
    final response = await _dataRepository.getProfitDay(startDate: startDate, endDate: endDate);
    emit(SellReportState.getProfitDay(data: state.data!.copyWith(profitDay: response)));
  }
