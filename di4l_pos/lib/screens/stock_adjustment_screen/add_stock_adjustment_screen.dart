...
class _AddStockAdjustmentScreenState extends State<AddStockAdjustmentScreen>
  ...
  final TextEditingController _txtfinalTotal = TextEditingController();
  ...
  FutureOr<void> afterFirstLayout(BuildContext context) {
    ...
    _txtfinalTotal.text = widget.stockAdjustmentData?.finalTotal ?? '';
                      ...
                      builder: (context, state) => Column(
                        children: [
                          Container(
                            ...
                            child: state.data!.productSelected != null
                                ? Column(
                                    children: [
                                      InkWell(
                                        child: Row(
                                      ...
                                      Padding(
                                        ...
                                        child: CustomTextField(
                                          controller: TextEditingController(
                                              text: state.data!.productSelected!
                                                  .alertQuantity
                                                  .toString()),
                                          hintText: '0.000'.tr,
